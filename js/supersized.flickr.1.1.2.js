	...
	switch(options.sort_direction){
    	...
    	switch(options.source){
	    	...
	    	case 2:		//From a User
	    		...
	    		break;
	    	case 3:		//From a Group
	    		var flickrURL =  'https://api.flickr.com/services/rest/?format=json&method=flickr.photos.search&extras=url_k,url_q,url_o&api_key=' + options.api_key + '&group_id=' + options.group + '&per_page=' + options.total_slides + '&sort=' + sort_order + '&format=json&nojsoncallback=1';
	    		break;
		case 4:		//From tags
	    		var flickrURL =  'https://api.flickr.com/services/rest/?format=json&method=flickr.photos.search&extras=url_k,url_q,url_o&api_key=' + options.api_key + '&tags=' + options.tags + '&per_page=' + options.total_slides + '&sort=' + sort_order + '&format=json&nojsoncallback=1';
	    		break;
	    }
